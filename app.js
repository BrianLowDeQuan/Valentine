...
no.addEventListener("click", () => {
  if (count == 2) {
    gif.src = "resources/cat-heart.gif";// gif credit: https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "就知道我的小臭臭喜欢我！😘";
  yes.innerHTML = '<a href="">see ya at 13th Feb 4pm</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
